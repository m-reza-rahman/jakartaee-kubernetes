...
* Start Eclipse IDE.
* Go to Help -> Eclipse Marketplace. Search for an install Liberty Tools.
* Server -> IBM -> WebSphere Application Server Liberty Extended Tools. Click Next. Accept the license agreement, click Finish.
